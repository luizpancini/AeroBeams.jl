...
*BWB's body properties*

![](assets/BWBwingprops.png)
*BWB's wing properties*
...
The stability results can be visualized through the following root locus and V-g-f (frequency and damping evolution) plots. It is seen that one of the modes crosses the zero-damping barrier, indicating flutter. Also notice that the mode tracking may not always work perfectly.
