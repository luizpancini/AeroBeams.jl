...
# Set paths
relPath = "/test/outputs/figures/plungingAirfoil"
...
display(plt_cn)
savefig(string(absPath,"/plungingAirfoil_cn.pdf"))
...
display(plt_cm)
savefig(string(absPath,"/plungingAirfoil_cm.pdf"))

println("Finished plungingAirfoilPlotGenerator.jl")