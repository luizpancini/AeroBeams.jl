...
# Animation
anim = plot_dynamic_deformation(problem,refBasis="I",plotFrequency=2,plotLimits=([0,2*L],[-L/2,L/2],[-L,0]),save=true,savePath=string(relPath,"/flyingScissors_deformation.gif"),displayProgress=true)
display(anim)
