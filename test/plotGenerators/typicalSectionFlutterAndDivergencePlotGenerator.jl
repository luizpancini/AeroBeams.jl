...
# V-g-f
plt11 = plot(ylabel="Frequency ratio", xlims=[0,URange[end]], ylims=[0,1.01])
...
plt12 = plot(xlabel="Airspeed [m/s]", ylabel="Damping Ratio", xlims=[0,URange[end]], ylims=[-0.15,0.15],legend=:topleft)
