...
# Set paths
relPath = "/test/outputs/figures/sweptBackDrivenFFWTWing"
absPath = string(pwd(),relPath)
mkpath(absPath)

# Deformed shape
deformationPlot = plot_steady_deformation(problem,view=(30,30),save=true,savePath=string(relPath,"/sweptBackDrivenFFWTWing_deformation.pdf"))
