...
# Set paths
relPath = "/test/outputs/figures/beamTorsionalVibrationCC"
...
display(plt1)
savefig(string(absPath,"/beamTorsionalVibrationCC_p1.pdf"))

println("Finished beamTorsionalVibrationCCPlotGenerator.jl")