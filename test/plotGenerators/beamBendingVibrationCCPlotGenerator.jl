...
# Set paths
relPath = "/test/outputs/figures/beamBendingVibrationCC"
...
display(plt1)
savefig(string(absPath,"/beamBendingVibrationCC_u3.pdf"))

println("Finished beamBendingVibrationCCPlotGenerator.jl")