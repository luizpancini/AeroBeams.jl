...
# Deformed shape
deformationPlot = plot_steady_deformation(problem,plotUndeformed=true,plotDistLoads=true,view=(30,30),save=true,savePath=string(relPath,"/drivenFoldingWingtip_deformation.pdf"))
