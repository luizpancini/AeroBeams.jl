...
# Animation
anim = plot_dynamic_deformation(problem,plotFrequency=5,view=(30,30),plotLimits=([0,L],[0,L],[-L/2,L/2]),save=true,savePath=string(relPath,"/elbowFrame_deformation.gif"),displayProgress=true)
display(anim)
