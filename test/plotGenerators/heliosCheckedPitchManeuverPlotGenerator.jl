...
# Animation
plot_dynamic_deformation(dynamicProblem,refBasis="I",view=(30,15),plotDistLoads=false,plotFrequency=5,plotLimits=[(-30,30),(0,100),(-20,20)],save=true,savePath=string(relPath,"/heliosCheckedPitchManeuver_deformation.gif"),displayProgress=true)
