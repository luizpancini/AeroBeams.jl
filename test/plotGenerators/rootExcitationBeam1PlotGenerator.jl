...
# Set paths
relPath = "/test/outputs/figures/rootExcitationBeam1"
...
display(plt1)
savefig(string(absPath,"/rootExcitationBeam1_V3oV.pdf"))
...
display(plt2)
savefig(string(absPath,"/rootExcitationBeam1_u3.pdf"))
...
display(plt3)
savefig(string(absPath,"/rootExcitationBeam1_V3.pdf"))

println("Finished rootExcitationBeam1PlotGenerator.jl")