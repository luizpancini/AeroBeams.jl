...
# Animation
anim = plot_dynamic_deformation(problem,plotFrequency=1,plotLimits=([-L,L],[0,L],[0,L]),save=true,savePath=string(relPath,"/rotationDrivenRobotArm_deformation.gif"),displayProgress=true)
display(anim)
