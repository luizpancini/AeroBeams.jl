...
# Animation
plot_dynamic_deformation(problem,refBasis="A",plotFrequency=1,view=(30,30),plotDistLoads=false,save=true,savePath=string(relPath,"/HealyFFWTOMCGustFloating_deformation.gif"),displayProgress=true)
...
display(plt1)
savefig(string(absPath,"/HealyFFWTOMCGustFloating_disp.pdf"))
