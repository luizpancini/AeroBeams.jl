...
# Deformed shape
deformationPlot = plot_steady_deformation(problem,scale=1e2,showScale=true,scalePos=[0.1,-0.8,0],save=true,savePath=string(relPath,"/hingedSpringedBeam_deformation.pdf"))
