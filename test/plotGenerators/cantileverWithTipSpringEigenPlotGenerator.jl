...
# Set paths
relPath = "/test/outputs/figures/cantileverWithTipSpringEigen"
...
display(plt1)
savefig(string(absPath,"/cantileverWithTipSpringEigen_u3.pdf"))

println("Finished cantileverWithTipSpringEigenPlotGenerator.jl")