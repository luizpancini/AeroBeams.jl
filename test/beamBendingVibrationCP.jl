...
# Model
beamBendingVibrationCP = Model(name="beamBendingVibrationCP",beams=[beam],BCs=[clamp,pin])

# Create and solve the problem
nModes=6
problem = EigenProblem(model=beamBendingVibrationCP,nModes=nModes,getLinearSolution=true,normalizeModeShapes=true)
solve!(problem)
