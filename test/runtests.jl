...
@testset "Dynamic analysis of the Pazy wing encountering a continuous, 1-dimensional gust defined over time" begin
    ...
    @test tipAoA[end] ≈ tipAoA_[end] atol=2e-3
    @test tipOOP[end] ≈ tipOOP_[end] atol=2e-3
    @test tqSpan_cn[end] ≈ tqSpan_cn_[end] atol=2e-3
    @test tqSpan_cm[end] ≈ tqSpan_cm_[end] atol=2e-3
    @test tqSpan_ct[end] ≈ tqSpan_ct_[end] atol=2e-3
end
