...
@testset "Static analysis of an arch under a dead pressure load" begin
    ...
    @test mid_u3 ≈ mid_u3_ rtol=SELFatol
end
...
@testset "Dynamic analysis of the axial vibration of a beam under a traction force applied suddenly" begin
    ...
    @test u1_08 ≈ u1_08_ rtol=SELFatol
    @test u1_10 ≈ u1_10_ rtol=SELFatol
end
...
@testset "Modal analysis of the axial vibration of a beam under clamped-clamped boundary conditions" begin
    ...
    @test freqs ≈ freqs_ rtol=SELFatol
    @test hcat(u1_modeShapes...)' ≈ u1_modeShapes_ rtol=SELFatol
end
...
@testset "Modal analysis of the bending vibration of a beam under clamped-clamped boundary conditions" begin
    ...
    @test freqs ≈ freqs_ rtol=SELFatol
    @test hcat(u3_modeShapes...)' ≈ u3_modeShapes_ rtol=SELFatol
end
...
@testset "Modal analysis of the torsional vibration of a beam under clamped-clamped boundary conditions" begin
    ...
    @test freqs ≈ freqs_ rtol=SELFatol
    @test hcat(p1_modeShapes...)' ≈ p1_modeShapes_ rtol=SELFatol
end
...
@testset "Dynamic analysis of the free response of a beam clamped at both ends and subjected to an initial displacement profile" begin
    ...
    @test u3_mid ≈ u3_mid_ rtol=SELFatol
    @test V3_mid ≈ V3_mid_ rtol=SELFatol
    @test Vdot3_mid ≈ Vdot3_mid_ rtol=SELFatol
    @test θ2_quarter ≈ θ2_quarter_ rtol=SELFatol
    @test Ω2_quarter ≈ Ω2_quarter_ rtol=SELFatol
    @test Ωdot2_quarter ≈ Ωdot2_quarter_ rtol=SELFatol
end
...
@testset "Flutter analysis of the Blended-Wing-Body flying wing" begin
    ...
    @test hcat(freqs...)' ≈ freqs_ rtol=SELFatol
    @test hcat(damps...)' ≈ damps_ rtol=SELFatol
end
...
@testset "Trim analysis of the Blended-Wing-Body flying wing in free flight" begin
    ...
    @test trimAoA ≈ trimAoA_ rtol=SELFatol
    @test trimThrust ≈ trimThrust_ rtol=SELFatol
    @test trimδ ≈ trimδ_ rtol=SELFatol
end
...
@testset "Static analysis of a cantilever beam bending under self weight" begin
    ...
    @test u1 ≈ u1_ rtol=SELFatol
    @test u3 ≈ u3_ rtol=SELFatol
    @test F3 ≈ F3_ rtol=SELFatol
    @test M2 ≈ M2_ rtol=SELFatol
end
...
@testset "Modal analysis of a cantilever beam with a tip axial inertia" begin
    ...
    @test freqsNorm ≈ freqsNorm_ rtol=SELFatol
    @test hcat(u1_modeShapes...)' ≈ u1_modeShapes_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a composite cantilever beam under a tip sinusoidal load" begin
    ...
    @test u1_tip ≈ u1_tip_ rtol=SELFatol
    @test u2_tip ≈ u2_tip_ rtol=SELFatol
    @test u3_tip ≈ u3_tip_ rtol=SELFatol
    @test p1_tip ≈ p1_tip_ rtol=SELFatol
    @test p2_tip ≈ p2_tip_ rtol=SELFatol
    @test p3_tip ≈ p3_tip_ rtol=SELFatol
    @test F1_root ≈ F1_root_ rtol=SELFatol
    @test F2_root ≈ F2_root_ rtol=SELFatol
    @test F3_root ≈ F3_root_ rtol=SELFatol
    @test M1_root ≈ M1_root_ rtol=SELFatol
    @test M2_root ≈ M2_root_ rtol=SELFatol
    @test M3_root ≈ M3_root_ rtol=SELFatol
end
...
@testset "Static analysis of composite laminates subjected to tip loads" begin
    ...
    for i in 1:3
        ...
        @test hcat(u1_500mm[i,:]...)' ≈ u1_500mm_ rtol=SELFatol
        @test hcat(u2_500mm[i,:]...)' ≈ u2_500mm_ rtol=SELFatol
        @test hcat(u3_500mm[i,:]...)' ≈ u3_500mm_ rtol=SELFatol
    end
end
...
@testset "Dynamic analysis the conventional HALE aircraft undergoing a checked pitch maneuver" begin
    ...
    @test rootAoA ≈ rootAoA_ rtol=SELFatol
    @test Δu3 ≈ Δu3_ rtol=SELFatol
end
...
@testset "Flutter analysis the conventional HALE aircraft in free flight with airspeed and structural stiffness as the varying parameters" begin
    ...
    for (i,λ) in enumerate(λRange)
        ...
        @test hcat(freqs[i,:]...)' ≈ freqs_ rtol=SELFatol
        @test hcat(damps[i,:]...)' ≈ damps_ rtol=SELFatol
    end
end
...
@testset "Static analysis of a curved cantilever subjected to a tip dead force" begin
    ...
    @test tip_u1 ≈ tip_u1_ rtol=SELFatol
    @test tip_u2 ≈ tip_u2_ rtol=SELFatol
    @test tip_u3 ≈ tip_u3_ rtol=SELFatol
end
...
@testset "Static analysis of a cantilever with distributed follower force" begin
    ...
    @test tip_u1 ≈ tip_u1_ rtol=SELFatol
    @test tip_u3 ≈ tip_u3_ rtol=SELFatol
    @test tip_angle ≈ tip_angle_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a double pendulum released from rest" begin
    ...
    @test u1_hinge ≈ u1_hinge_ rtol=SELFatol
    @test u3_hinge ≈ u3_hinge_ rtol=SELFatol
    @test u1_tip ≈ u1_tip_ rtol=SELFatol
    @test u3_tip ≈ u3_tip_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a harmonically pitching airfoil, using the dynamic stall model" begin
    ...
    @test cn ≈ cn_ rtol=SELFatol
    @test cm ≈ cm_ rtol=SELFatol
    @test ct ≈ ct_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a right-angled frame subjected to an out-of-plane force" begin
    ...
    @test u3_elbow ≈ u3_elbow_ rtol=SELFatol
    @test u3_tip ≈ u3_tip_ rtol=SELFatol
end
...
@testset "Dynamic analysis of two airfoils with linked harmonic flap deflection profiles" begin
    ...
    @test cnMaster ≈ cnMaster_ rtol=SELFatol
    @test cmMaster ≈ cmMaster_ rtol=SELFatol
    @test cnSlave ≈ cnSlave_ rtol=SELFatol
    @test cmSlave ≈ cmSlave_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a hinged beam in free flight" begin
    ...
    @test u1_tipA ≈ u1_tipA_ rtol=SELFatol
    @test u3_tipA ≈ u3_tipA_ rtol=SELFatol
    @test u1_tipB ≈ u1_tipB_ rtol=SELFatol
    @test u3_tipB ≈ u3_tipB_ rtol=SELFatol
    @test u1_hinge ≈ u1_hinge_ rtol=SELFatol
    @test u3_hinge ≈ u3_hinge_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a very flexible beam subjected to loads yielding tri-dimensional motion" begin
    ...
    @test u2_tip ≈ u2_tip_ rtol=SELFatol
    @test u3_tip ≈ u3_tip_ rtol=SELFatol
    @test θ_tip ≈ θ_tip_ rtol=SELFatol
end
...
@testset "Static analysis of a T-frame hinged at the connection subjected to a distributed load" begin
    ...
    @test u1_beam1 ≈ u1_beam1_ rtol=SELFatol
    @test u1_beam2 ≈ u1_beam2_ rtol=SELFatol
    @test u3_beam1 ≈ u3_beam1 rtol=SELFatol
    @test u3_beam2 ≈ u3_beam2_ rtol=SELFatol
    @test F3_beam1 ≈ F3_beam1_ rtol=SELFatol
    @test M2_beam1 ≈ M2_beam1_ rtol=SELFatol
end
...
@testset "Dynamic analysis of the free response of a beam subjected to initial displacement and velocity profiles" begin
    ...
    @test u3_quarter ≈ u3_quarter_ rtol=SELFatol
    @test V3_quarter ≈ V3_quarter_ rtol=SELFatol
    @test Vdot3_quarter ≈ Vdot3_quarter_ rtol=SELFatol
    @test θ2_root ≈ θ2_root_ rtol=SELFatol
    @test Ω2_mid ≈ Ω2_mid_ rtol=SELFatol
    @test Ωdot2_mid ≈ Ωdot2_mid_ rtol=SELFatol
end
...
@testset "Static analysis of the Lee frame (a right-angled frame) with a dead load" begin
    ...
    @test u1_atForce ≈ u1_atForce_ rtol=SELFatol
    @test u3_atForce ≈ u3_atForce_ rtol=SELFatol
end
    ...
    for (i,aeroSolver) in enumerate(aeroSolvers)
        for (j,gustLoadsSolver) in enumerate(gustLoadsSolvers)
            for (k,testCase) in enumerate(1:6)
                ...
                @test Δcl[i,j,k] ≈ Δcl_ rtol=SELFatol
            end
        end
    end
end
...
@testset "Steady analysis of the Pazy wing with flared folding wing tip (FFWT)" begin
    ...
    @test u3_of_x1 ≈ u3_of_x1_ rtol=SELFatol
    @test p2_of_x1 ≈ p2_of_x1_ rtol=SELFatol
    @test M2_of_x1 ≈ M2_of_x1_ rtol=SELFatol
end
...
@testset "Static analysis of the pure bending test of the Pazy wing" begin
    ...
    @test tip_OOP ≈ tip_OOP_ rtol=SELFatol
    @test tip_twist ≈ tip_twist_ rtol=SELFatol
end
...
@testset "Dynamic analysis of the Pazy wing encountering a continuous, 1-dimensional gust defined over time" begin
    ...
    @test tipAoA ≈ tipAoA_ rtol=SELFatol
    @test tipOOP ≈ tipOOP_ rtol=SELFatol
    @test tqSpan_cn ≈ tqSpan_cn_ rtol=SELFatol
    @test tqSpan_cm ≈ tqSpan_cm_ rtol=SELFatol
    @test tqSpan_ct ≈ tqSpan_ct_ rtol=SELFatol
end
...
@testset "Flutter analysis of the Pazy wing" begin
    ...
    @test hcat(filter(x->!isempty(x),flutterOnsetSpeedsOfMode)...)' ≈ flutterOnsetSpeedsOfMode_ rtol=SELFatol
    @test hcat(filter(x->!isempty(x),flutterOnsetFreqsOfMode)...)' ≈ flutterOnsetFreqsOfMode_ rtol=SELFatol
    @test hcat(filter(x->!isempty(x),flutterOnsetDispOfMode)...)' ≈ flutterOnsetDispOfMode_ rtol=SELFatol
    @test hcat(filter(x->!isempty(x),flutterOffsetSpeedsOfMode)...)' ≈ flutterOffsetSpeedsOfMode_ rtol=SELFatol
    @test hcat(filter(x->!isempty(x),flutterOffsetFreqsOfMode)...)' ≈ flutterOffsetFreqsOfMode_ rtol=SELFatol
    @test hcat(filter(x->!isempty(x),flutterOffsetDispOfMode)...)' ≈ flutterOffsetDispOfMode_ rtol=SELFatol
end
...
@testset "Steady analysis of the Pazy wing with varying root pitch angle" begin
    ...
    @test filter(!isnan,tip_AoA) ≈ filter(!isnan,tip_AoA_) rtol=SELFatol
    @test tip_OOP ≈ tip_OOP_ rtol=SELFatol
    @test tip_IP ≈ tip_IP_ rtol=SELFatol
    @test tip_twist ≈ tip_twist_ rtol=SELFatol
end
...
@testset "Static analysis of a mid-loaded arch pinned at one end and clamped at the other" begin
    ...
    @test u1_atForce ≈ u1_ rtol=SELFatol
    @test u3_atForce ≈ u3_ rtol=SELFatol
end
...
@testset "Trim analysis (reaction loads check) of a right-angled frame" begin
    ...
    @test balanceHorizontalForce ≈ balanceHorizontalForce_ rtol=SELFatol
    @test balanceVerticalForce ≈ balanceVerticalForce_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a clamped beam with root sinusoidal oscillation (ω = 9 Hz ≈ 2nd bending mode)" begin
    ...
    @test u3b_root ≈ u3b_root_ rtol=SELFatol
    @test u3b_tip ≈ u3b_tip_ rtol=SELFatol
    @test V3_root ≈ V3_root_ rtol=SELFatol
    @test V3_tip ≈ V3_tip_ rtol=SELFatol
end
...
@testset "Dynamic analysis of a rotary shaft with specified rotation" begin
    ...
    @test pNum ≈ pNum_ rtol=SELFatol
    @test pdotNum ≈ pdotNum_ rtol=SELFatol
    @test ΩNum ≈ ΩNum_ rtol=SELFatol
    @test ΩdotNum ≈ ΩdotNum_ rtol=SELFatol
    @test MNum ≈ MNum_ rtol=SELFatol
end
...
@testset "Flutter analysis of the sixteen-meter-wing" begin
    ...
    @test x1_def[end]/L ≈ x1_ rtol=SELFatol
    @test x3_def[end]/L ≈ x3_ rtol=SELFatol
    @test α_of_x1[end]*180/pi ≈ α_ rtol=SELFatol
    for mode in 1:nModes
        ...
        @test modeFrequencies[mode] ≈ freqs_ rtol=SELFatol
        @test modeDampings[mode] ≈ damps_ rtol=SELFatol
    end
end
...
@testset "Flutter boundary analysis of the sixteen-meter-wing as a function of the pitch angle" begin
    ...
    for i in 1:nModes
        ...
        @test modeFrequencies[i] ≈ freqs_ rtol=SELFatol
        @test modeDampings[i] ≈ damps_ rtol=SELFatol
    end
end
...
@testset "Flutter boundary analysis of the sixteen-meter-wing as a function of the wing curvature with tip load as the varying parameter" begin
    ...
    for i in eachindex(kRange)
        ...
        @test flutterSpeed[i,:] ≈ flutterSpeed_ rtol=SELFatol
    end
end
...
@testset "Flutter boundary analysis of the sixteen-meter-wing as a function of the wing curvature with root angle as the varying parameter" begin
    ...
    for (ki,k) in enumerate(kRange)
        for (i,θ) in enumerate(θRange)
            ...
            @test hcat(freqs[ki,i,:]...)' ≈ freqs_ rtol=SELFatol
            @test hcat(damps[ki,i,:]...)' ≈ damps_ rtol=SELFatol
        end
    end
end
...
@testset "Flutter boundary analysis of the sixteen-meter-wing as a function of the bending-torsion coupling factor" begin
    ...
    @test flutterSpeed ≈ flutterSpeed_ rtol=SELFatol
end
...
@testset "Flutter boundary analysis of the sixteen-meter-wing as a function of the tip displacement" begin
    ...
    @test flutterSpeed ≈ flutterSpeed_ rtol=SELFatol
    @test flutterFreq ≈ flutterFreq_ rtol=SELFatol
end
...
@testset "Dynamic analysis of the spin-up maneuver of a robot arm" begin
    ...
    @test u1_tip ≈ u1_tip_ rtol=SELFatol
    @test u2_tip ≈ u2_tip_ rtol=SELFatol
    @test θ3_root ≈ θ3_root_ rtol=SELFatol
end
...
@testset "Eigen-analysis of a straight rotor" begin
    ...
    @test hcat(numFreqs...)' ≈ freqs_ rtol=SELFatol
end
...
@testset "Eigen-analysis of a swept-tip rotor" begin
    ...
    @test numFreqs[end,end] ≈ freqs_ rtol=SELFatol
end
...
@testset "Dynamic analysis of an airfoil section sinusoidally surging (facing a time-varying freestream)" begin
    ...
    @test cn[end] ≈ cn_ rtol=SELFatol
    @test cm[end] ≈ cm_ rtol=SELFatol
end
