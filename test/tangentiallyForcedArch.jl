...
# Model
tangentiallyForcedArch = Model(name="tangentiallyForcedArch",beams=[beam],BCs=[clamp,tipFollowerForce])
...
problem = SteadyProblem(model=tangentiallyForcedArch,systemSolver=NR)
solve!(problem)
