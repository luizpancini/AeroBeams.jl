...
# Model
beamBendingVibrationCF = Model(name="beamBendingVibrationCF",beams=[beam],BCs=[clamp])

# Create and solve the problem
nModes=6
problem = EigenProblem(model=beamBendingVibrationCF,nModes=nModes,getLinearSolution=true,normalizeModeShapes=true)
solve!(problem)
