...
#md # Finally, we may visually check the undeformed assembly through the function [`plot_undeformed_assembly`](@ref plot_undeformed_assembly):
## Visualization
#md using Plots #hide
p1 = plot_undeformed_assembly(conventionalHALE, view=(30,30))
#md nothing #hide
#md savefig("conventionalHALE.svg") #hide
#md nothing #hide
