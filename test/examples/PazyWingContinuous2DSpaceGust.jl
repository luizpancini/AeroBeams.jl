...
# Model
PazyWingContinuous2DSpaceGust,nElem,_ = create_Pazy(aeroSolver=aeroSolver,gustLoadsSolver=gustLoadsSolver,upright=upright,θ=θ,airspeed=U,gust=gust)
...
problem = create_DynamicProblem(model=PazyWingContinuous2DSpaceGust,finalTime=tf,Δt=Δt,systemSolver=NR,initialVelocitiesUpdateOptions=initialVelocitiesUpdateOptions)
solve!(problem)
