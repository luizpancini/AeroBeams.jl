...
# Model
beamTorsionalVibrationCF = create_Model(name="beamTorsionalVibrationCF",beams=[beam],BCs=[clamp])

# Create and solve the problem
nModes=6
problem = create_EigenProblem(model=beamTorsionalVibrationCF,nModes=nModes,getLinearSolution=true,normalizeModeShapes=true)
solve!(problem)
...
println("Finished beamTorsionalVibrationCF.jl")