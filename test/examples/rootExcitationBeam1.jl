...
# Model
rootExcitationBeam1 = create_Model(name="rootExcitationBeam1",beams=[beam],BCs=[shaker],gravityVector=[0,0,-9.80665])
...
problem = create_DynamicProblem(model=rootExcitationBeam1,finalTime=tf,Δt=Δt)
solve!(problem)

# Unpack numerical solution
t = problem.timeVector
x1 = [v.x1 for v in rootExcitationBeam1.elements]
...
println("Finished rootExcitationBeam1.jl")