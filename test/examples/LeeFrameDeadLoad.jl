...
u1Ref = readdlm(joinpath(dirname(@__DIR__), "referenceData", "LeeFrameDeadLoad", "u1.txt"))
u3Ref = readdlm(joinpath(dirname(@__DIR__), "referenceData", "LeeFrameDeadLoad", "u3.txt"))
