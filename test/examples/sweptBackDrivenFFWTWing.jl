...
# Other hinge variables
pH = problem.model.hingeAxisConstraints[1].pH
currentHingeAxis = problem.model.hingeAxisConstraints[1].currentHingeAxis
normalized_pH = pH ./ currentHingeAxis
