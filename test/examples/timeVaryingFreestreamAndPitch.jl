...
# Load reference data
cnCFDLambda0_2 = readdlm(joinpath(dirname(@__DIR__), "referenceData", "timeVaryingFreestreamAndPitch", "cnCFDLambda0_2.txt"))
cmCFDLambda0_2 = readdlm(joinpath(dirname(@__DIR__), "referenceData", "timeVaryingFreestreamAndPitch", "cmCFDLambda0_2.txt"))
