...
# Model
clampedFlaredHingedBeam = create_Model(name="clampedFlaredHingedBeam",beams=[beam],BCs=[clamp,tipNormalForce,tipInplaneForce],hingeAxisConstraints=[hingeAxisConstraint])
...
# Compute rotation angle about the hinge node
