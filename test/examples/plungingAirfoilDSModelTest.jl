...
nElem = 1
∞ = 1e10
wing = create_Beam(name="beam",length=L,nElements=nElem,S=[isotropic_stiffness_matrix(∞=∞)],I=[inertia_matrix(ρA=0.1)],rotationParametrization="E321",p0=[0;0;0],aeroSurface=surf)
...
Nt = length(t)
α_eq = [problem.aeroVariablesOverTime[j][1].flowAnglesAndRates.α for j in 1:Nt]
