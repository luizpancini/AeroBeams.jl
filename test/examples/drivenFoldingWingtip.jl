...
# Model
drivenFoldingWingtip = create_Model(name="drivenFoldingWingtip",beams=[beam],BCs=[clamp],hingeAxisConstraints=[hingeAxisConstraint])
...
# Display results
println("Hinge fold angle = $ϕHinge deg")

println("Finished drivenFoldingWingtip.jl")