...
u3_quarter_analytic = δ*cos.(ω2*t)*sin(2*π*1/4) + σ/ω2*sin.(ω2*t)*sin(2*π*1/4)
V3_quarter_analytic = -δ*ω2*sin.(ω2*t)*sin(2*π*1/4) + σ*cos.(ω2*t)*sin(2*π*1/4)
Vdot3_quarter_analytic = -δ*ω2^2*cos.(ω2*t)*sin(2*π*1/4) + -σ*ω2*sin.(ω2*t)*sin(2*π*1/4)
θ2_root_analytic = -δ*2*π/L*cos.(ω2*t)*cos(2*π*0) + -σ*2*π/L/ω2*sin.(ω2*t)*cos(2*π*0)
Ω2_mid_analytic = δ*2*π/L*ω2*sin.(ω2*t)*cos(2*π*1/2) + -σ*2*π/L*cos.(ω2*t)*cos(2*π*1/2)
Ωdot2_mid_analytic = δ*2*π/L*ω2^2*cos.(ω2*t)*cos(2*π*1/2) + σ*2*π/L*ω2*sin.(ω2*t)*cos(2*π*1/2)
