...
# Flutter analysis of the Healy sideslip FFWT wing with sideslip angle as the varying parameter
...
# Flutter analysis of the Healy sideslip FFWT wing with airspeed as the varying parameter
