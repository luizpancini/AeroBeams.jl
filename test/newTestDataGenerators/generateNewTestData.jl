...
writedlm("test/newTestDataGenerators/biclampedBeam/θ2_quarter.txt", θ2_quarter)
writedlm("test/newTestDataGenerators/biclampedBeam/Ω2_quarter.txt", Ω2_quarter)
writedlm("test/newTestDataGenerators/biclampedBeam/Ωdot2_quarter.txt", Ωdot2_quarter)
...
writedlm("test/newTestDataGenerators/initialDispAndVelBeam/θ2_root.txt", θ2_root)
writedlm("test/newTestDataGenerators/initialDispAndVelBeam/Ω2_mid.txt", Ω2_mid)
writedlm("test/newTestDataGenerators/initialDispAndVelBeam/Ωdot2_mid.txt", Ωdot2_mid)
...
writedlm("test/newTestDataGenerators/initialDisplacementBeam/θ2_root.txt", θ2_root)
writedlm("test/newTestDataGenerators/initialDisplacementBeam/Ω2_mid.txt", Ω2_mid)
writedlm("test/newTestDataGenerators/initialDisplacementBeam/Ωdot2_mid.txt", Ωdot2_mid)
...
writedlm("test/newTestDataGenerators/initialVelocityBeam/θ2_root.txt", θ2_root)
writedlm("test/newTestDataGenerators/initialVelocityBeam/Ω2_mid.txt", Ω2_mid)
writedlm("test/newTestDataGenerators/initialVelocityBeam/Ωdot2_mid.txt", Ωdot2_mid)
...
writedlm("test/newTestDataGenerators/rotaryShaft/ΩNum.txt", ΩNum)
writedlm("test/newTestDataGenerators/rotaryShaft/ΩdotNum.txt", ΩdotNum)
...
writedlm("test/newTestDataGenerators/spinupRobotArm/θ3_root.txt", θ3_root)
